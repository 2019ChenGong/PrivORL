...
# pretrain
CUDA_VISIBLE_DEVICES=1 nohup python train_diffuser.py --full_pretrain --results_folder './results_full' &> full_pre.out& 
# finetune
CUDA_VISIBLE_DEVICES=1 nohup python train_diffuser.py --full_pretrain --load_checkpoint --dataset hopper-medium-replay-v2 --save_file_name hopper_5m_samples_5ep.npz --dp_epsilon=5.0 --results_folder './results_full' &> full_pre.out& 
...
# pretrain
CUDA_VISIBLE_DEVICES=0 nohup python train_diffuser.py --results_folder './results_part' &> part_pre.out& 
# finetune
