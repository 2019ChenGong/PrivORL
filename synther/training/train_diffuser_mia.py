...
def load_data(dataset_name, sample_ratio):
    # Load data directly from saved npy file
    # The data is already in d4rl format: [obs, actions, rewards, next_obs, terminals]
    train_data_path = f'{args.results_folder}/train_data_1000.npy'
    ...
    print(f"Loaded training data from {train_data_path}, shape: {input.shape}")
