...
python synther/training/train_diffuser.py \
  ...
  --results_folder ./evaluation/eval-mia/alter_for_mia_curiosity_driven_results_maze2d-medium-dense-v1 

python synther/training/train_diffuser_mia.py \
  --dataset maze2d-medium-dense-v1 \
  --results_folder ./evaluation/eval-mia/alter_for_mia_curiosity_driven_results_maze2d-medium-dense-v1 \
  --load_path ./evaluation/eval-mia/alter_for_mia_curiosity_driven_results_maze2d-medium-dense-v1/pretraining-model-4.pt \
