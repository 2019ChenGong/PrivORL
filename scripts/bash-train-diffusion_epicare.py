...
datasets = [
            ...
            # "walker2d-medium-replay-v2",
            "EpiCare/data/smart/train_seed_1.hdf5"
            ]
# datasets = ["halfcheetah-medium-replay-v2"]
...
datasets_name = {"halfcheetah-medium-replay-v2": ['walker2d-full-replay-v2', 'halfcheetah-expert-v2', 'walker2d-medium-v2'],
                 ...
                 # epicare
                 "EpiCare/data/smart/train_seed_1.hdf5":    ['EpiCare/data/smart/test_seed_2.hdf5',
                                                            'EpiCare/data/smart/test_seed_3.hdf5', 
                                                            'EpiCare/data/smart/test_seed_4.hdf5'],  
                 }
                ...
                for dp_epsilon in dp_epsilons:
                    for finetuning_rate in finetuning_rates:
                        for curiosity_driven_rate in curiosity_driven_rates:
                            ...
                            results_folder = f"./results_epicare_{curiosity_driven_rate}_{accountant}"
                            ...
                            store_path = f"epicare_samples_{num_sample}_{dp_epsilon}dp_{finetuning_rate}_{accountant}.npz"
                            ...
                            script_path = 'synther/training/train_diffuser_epicare.py'
