...
class TrainConfig:
    ...
    def __post_init__(self):
        ...
        self.name = f"{self.prefix}_{self.name}-iql-{self.env}-epsilon_{self.dp_epsilon}-seed_{self.seed}-{str(formatted_datetime)}"
...
def train(config: TrainConfig):
    with h5py.File("/bigtemp/fzv6en/SynthER/EpiCare/data/smart/train_seed_1.hdf5", "r") as f:
