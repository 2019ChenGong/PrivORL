        ...
        for seed in seeds:
            for num_sample in num_samples:
                for dp_epsilon in dp_epsilons:
                    ...
                    load_path = os.path.join(results_folder, "model-390000.pt")
                    store_path = os.path.join(results_folder, f"{dataset}_samples_{num_sample}_{dp_epsilon}dp.npz")
